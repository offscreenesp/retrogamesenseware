...
void ClanTag()
{
	...
	case 1:
	{
		...
		switch (value) {
		case 0:SetClanTag("retroware", ""); break;
...
void __fastcall PaintTraverse_Hooked(PVOID pPanels, int edx, unsigned int vguiPanel, bool forceRepaint, bool allowForce)
{
	...
	else if (FocusOverlayPanel == vguiPanel)
	{
		...
		}
	    {
			...
			Render::Text(1173, 15, Color(255, 255, 255, 255), Render::Fonts::supremacy, ("retroware |"));
			Render::Textf(1242, 15, Color(255, 255, 255, 255), Render::Fonts::supremacy, ("%s | 24 may"), GetTimeString().c_str());
		}
